...
class TrajectoryDemo():
    def __init__(self):
        ...
        x = loadmat('hex_wave.mat')#hex_transversal hex_lateral2 hex_lateral_r hex_wave
        # print x
        pierna1 = x['pierna1']
        pierna2 = x['pierna2']
        pierna3 = x['pierna3']
        ...
        for i in range(1, int(pierna1.shape[1]*0.25), salto):
            piernasLF_goalF01 = [pierna6[0, i], pierna6[1, i], pierna6[2, i], -0.4]#0.35
            lf_trajectory1.points.append(JointTrajectoryPoint())
            ...
            piernasLM_goalF01 = [pierna5[0, i], pierna5[1, i], pierna5[2, i], -0.4]#0.35
            lm_trajectory1.points.append(JointTrajectoryPoint())
            ...
            piernasLR_goalF01 = [pierna4[0, i], pierna4[1, i], pierna4[2, i], -0.4]#0.35
            lr_trajectory1.points.append(JointTrajectoryPoint())
            ...
            piernasRF_goalF01 = [pierna3[0, i], -pierna3[1, i], -pierna3[2, i], 0.4]#0.35
            rf_trajectory1.points.append(JointTrajectoryPoint())
            ...
            piernasRM_goalF01 = [pierna2[0, i], -pierna2[1, 0], -pierna2[2, i], 0.4]#0.35
            rm_trajectory1.points.append(JointTrajectoryPoint())
            ...
            piernasRR_goalF01 = [pierna1[0, i], -pierna1[1, 0], -pierna1[2, i], 0.4]#0.35
            rr_trajectory1.points.append(JointTrajectoryPoint())
