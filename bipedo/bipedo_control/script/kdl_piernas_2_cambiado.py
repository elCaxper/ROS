...
class TrajectoryDemo():
    def __init__(self):
        ...
        q_init_der_up_down = posicionInicial_der_up_down  # initial angles
        # desiredFrame = PyKDL.Frame(PyKDL.Vector(0.5, 0.4, 1))
        desiredFrame0.p[0] = desiredFrame0.p[0]+ 0.01#nada
        desiredFrame0.p[1] = desiredFrame0.p[1] -0.06#-0.07
        desiredFrame0.p[2] = desiredFrame0.p[2]-0.005#nada
        print "Desired Position_der_casi_ini: ", desiredFrame0.p
        q_out_der_up_down = PyKDL.JntArray(cadena_der_up_down.getNrOfJoints())
        ik_der_up_down.CartToJnt(q_init_der_up_down, desiredFrame0, q_out_der_up_down)
        print "Output angles in rads: ", q_out_der_up_down

        piernas_goal12[0] = q_out_der_up_down[0]*0
        piernas_goal12[1] = q_out_der_up_down[1]
        piernas_goal12[2] = q_out_der_up_down[2]
        piernas_goal12[3] = q_out_der_up_down[3]
        piernas_goal12[4] = q_out_der_up_down[4]-0.1
        ...
        # desiredFrame = PyKDL.Frame(PyKDL.Vector(0.5, 0.4, 1))
        desiredFrame2.p[0] = desiredFrame2.p[0] -0.06#0.065
        desiredFrame2.p[1] = desiredFrame2.p[1] -0.055#0.055
        desiredFrame2.p[2] = desiredFrame2.p[2] -0.02 #0.02
        ...
        piernas_goal2[10] = q_out_izq_down_up[1] - 0.08
        piernas_goal2[11] = q_out_izq_down_up[0] - 0.05
        ...
        print "Output angles in rads22222der_2: ", q_out_der_down_up
        ...
        desiredFrame4.p[1] = desiredFrame4.p[1]
        ...
        desiredFrame5.p[1] = desiredFrame5.p[1] - 0.1#0.1
        desiredFrame5.p[2] = desiredFrame5.p[2]
        ...
        print "Output angles in rads_izq_2222: ", q_out_izq_up_down2
        ...
        desiredFrame6.p[1] = desiredFrame6.p[1]-0.025
        ...
        piernas_goal121[6] = q_out_izq_up_down[0]*0
        ...
        q_out_der_up_down21 = [0,-.3, -.3, .6, .3, -.3 ]
        ...
        # desiredFrame = PyKDL.Frame(PyKDL.Vector(0.5, 0.4, 1))
        desiredFrame7.p[0] = desiredFrame7.p[0] + 0.03#0.03  # PROBAR A PONERLO MAYOR
        desiredFrame7.p[1] = desiredFrame7.p[1] - 0.065#0.04
        desiredFrame7.p[2] = desiredFrame7.p[2]
        ...
        piernas_goal25[6] = 0 #q_out_izq_down_up5[5]
        piernas_goal25[7] = 0.3 #q_out_izq_down_up5[4]
        piernas_goal25[8] = -0.3 #q_out_izq_down_up5[3]
        piernas_goal25[9] = 0.6 #q_out_izq_down_up5[2]
        piernas_goal25[10] = -0.3 #q_out_izq_down_up5[1]-0.05
        piernas_goal25[11] = -0.3#q_out_izq_down_up5[0]+0.05
        ...
        # desiredFrame = PyKDL.Frame(PyKDL.Vector(0.5, 0.4, 1))
        desiredFrame7.p[0] = desiredFrame7.p[0] + 0.065 # + 0.65
        desiredFrame7.p[1] = desiredFrame7.p[1] - 0.058 #-0.5
        desiredFrame7.p[2] = desiredFrame7.p[2] - 0.013  #-0.02
        ...
        piernas_goal25[4] = q_out_der_down_up71[1]+0.05
        piernas_goal25[5] = q_out_der_down_up71[0]-0.05
        ...
        desiredFrame541.p[0] = desiredFrame541.p[0]
        ...
        '''datos_articulaciones_txt = open('datos_articulacione_2.txt', 'wb')
        datos_articulaciones_txt.write(", ".join(map(lambda x: str(x), piernas_goal0)))
        datos_articulaciones_txt.write("\n")
        datos_articulaciones_txt.write(", ".join(map(lambda x: str(x), piernas_goal12)))
        datos_articulaciones_txt.write("\n")
        datos_articulaciones_txt.write(", ".join(map(lambda x: str(x), piernas_goal2)))
        datos_articulaciones_txt.write("\n")
        datos_articulaciones_txt.write(", ".join(map(lambda x: str(x), piernas_goal3)))
        datos_articulaciones_txt.write("\n")
        datos_articulaciones_txt.write(", ".join(map(lambda x: str(x), piernas_goal121)))
        datos_articulaciones_txt.write("\n")
        datos_articulaciones_txt.write(", ".join(map(lambda x: str(x), piernas_goal25)))
        datos_articulaciones_txt.write("\n")
        datos_articulaciones_txt.write(", ".join(map(lambda x: str(x), piernas_goal341)))
        datos_articulaciones_txt.close()

        datos_articulacionespkl = open('datos_articulacionespkl.pkl', 'wb')
        pickle.dump(piernas_goal0, datos_articulacionespkl, -1)
        pickle.dump(piernas_goal12, datos_articulacionespkl, -1)
        pickle.dump(piernas_goal2, datos_articulacionespkl, -1)
        pickle.dump(piernas_goal3, datos_articulacionespkl, -1)
        pickle.dump(piernas_goal121, datos_articulacionespkl, -1)
        pickle.dump(piernas_goal25, datos_articulacionespkl, -1)
        pickle.dump(piernas_goal341, datos_articulacionespkl, -1)

        datos_articulacionespkl.close()'''
        ...
        paso_normal = JointTrajectory()
        paso_normal.joint_names = piernas_joints
        paso_normal.points.append(JointTrajectoryPoint())
        paso_normal.points[0].positions = piernas_goal12
        paso_normal.points[0].velocities = [0.0 for i in piernas_joints]
        paso_normal.points[0].accelerations = [0.0 for i in piernas_joints]
        paso_normal.points[0].time_from_start = rospy.Duration(4.0)
        paso_normal.points.append(JointTrajectoryPoint())
        paso_normal.points[1].positions = piernas_goal2
        paso_normal.points[1].velocities = [0.0 for i in piernas_joints]
        paso_normal.points[1].accelerations = [0.0 for i in piernas_joints]
        paso_normal.points[1].time_from_start = rospy.Duration(6.0)
        paso_normal.points.append(JointTrajectoryPoint())
        paso_normal.points[2].positions = piernas_goal3
        paso_normal.points[2].velocities = [0.0 for i in piernas_joints]
        paso_normal.points[2].accelerations = [0.0 for i in piernas_joints]
        paso_normal.points[2].time_from_start = rospy.Duration(8.0)
        paso_normal.points.append(JointTrajectoryPoint())
        paso_normal.points[3].positions = piernas_goal121
        paso_normal.points[3].velocities = [0.0 for i in piernas_joints]
        paso_normal.points[3].accelerations = [0.0 for i in piernas_joints]
        paso_normal.points[3].time_from_start = rospy.Duration(10.0)
        paso_normal.points.append(JointTrajectoryPoint())
        paso_normal.points[4].positions = piernas_goal25
        paso_normal.points[4].velocities = [0.0 for i in piernas_joints]
        paso_normal.points[4].accelerations = [0.0 for i in piernas_joints]
        paso_normal.points[4].time_from_start = rospy.Duration(12.0)
        paso_normal.points.append(JointTrajectoryPoint())
        paso_normal.points[5].positions = piernas_goal341
        paso_normal.points[5].velocities = [0.0 for i in piernas_joints]
        paso_normal.points[5].accelerations = [0.0 for i in piernas_joints]
        paso_normal.points[5].time_from_start = rospy.Duration(14.0)
        ...
        paso_normal2 = FollowJointTrajectoryGoal()

        # Set the trajectory component to the goal trajectory created above
        piernas_goal.trajectory = arm_trajectory
        paso_normal2.trajectory = paso_normal
        # Specify zero tolerance for the execution time
        piernas_goal.goal_time_tolerance = rospy.Duration(0.01)
        paso_normal2.goal_time_tolerance = rospy.Duration(0.01)
        ...
        arm_client.send_goal(paso_normal2)
        arm_client.wait_for_result()
        arm_client.send_goal(paso_normal2)
        arm_client.wait_for_result()
        arm_client.send_goal(paso_normal2)
