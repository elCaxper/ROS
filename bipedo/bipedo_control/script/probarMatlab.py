...
class TrajectoryDemo():
    def __init__(self):
        ...
        piernas_goalF01 = [00.0 * art1_der['senialCompleta'][0, 0], 0.4*art2_der['senialCompleta'][0, 0],1.0*art3_der['senialCompleta'][0, 0] ,
                         art4_der['senialCompleta'][0, 0] , 0.4*art5_der['senialCompleta'][0, 0],1.0*art6_der['senialCompleta'][0, 0] +0.1,
                         0.0 * art1_izq['senialCompleta'][0, 0], 0.4*art2_izq['senialCompleta'][0, 0],1.0*art3_izq['senialCompleta'][0, 0] ,
                         art4_izq['senialCompleta'][0, 0] , 0.4*art5_izq['senialCompleta'][0, 0],1.0*art6_izq['senialCompleta'][0, 0] +0.1]
        arm_trajectory.points.append(JointTrajectoryPoint())
        ...
        ind = 1;
        salto =5;
        for i in range(1, int(art1_der['senialCompleta'].shape[1]*0.25), salto):
            # print ind
            # print int(art1_der['senialCompleta'].shape[1]*0.2)
            piernas_goalF = [0.0*art1_der['senialCompleta'][0, i], 0.4*art2_der['senialCompleta'][0, i], 1.0*art3_der['senialCompleta'][0, i],
                             art4_der['senialCompleta'][0, i], 0.4*art5_der['senialCompleta'][0, i], 1.0*art6_der['senialCompleta'][0, i]+0.1,
                             0.0*art1_izq['senialCompleta'][0, i], 0.4*art2_izq['senialCompleta'][0, i], 1.0*art3_izq['senialCompleta'][0, i],
                             art4_izq['senialCompleta'][0, i], 0.4*art5_izq['senialCompleta'][0, i], 1.0*art6_izq['senialCompleta'][0, i]+0.1]
            arm_trajectory.points.append(JointTrajectoryPoint())
            ...
            # 0.01 * (ind + 1)
            arm_trajectory.points[ind].time_from_start = rospy.Duration( 2+art1_der['tiempo_completo'][0, i])
